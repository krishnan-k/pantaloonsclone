...
import womenShoplook from "../collection-products/Womenshoplook";

const Womenshoplook = () => {
  return (
    <div className="women-shop-look card_collection_one mt-3 mb-3 pt-3 pb-3">
