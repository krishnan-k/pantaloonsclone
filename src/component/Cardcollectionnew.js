          ...
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹719</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹830</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹750</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹650</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹780</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹560</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹630</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="card border-0">
              ...
              <div class="card-body">
                ...
                <p className="product_price mb-0">₹648</p>
              </div>
            </div>
          </SwiperSlide>
        </Swiper>
